# SQL ve Power BI E-Ticaret Veri Analizi Portföyü

Bu depo, e-ticaret verileri üzerinde hazırladığım **SQL veri analizi çalışmalarını** ve **Power BI dashboard projelerini** içerir.

Çalışmaların amacı; iş sorularını SQL sorgularına dönüştürmek, veri kalitesi kontrolleri yapmak, temel performans göstergelerini hesaplamak ve sonuçları Power BI ile anlaşılır raporlara dönüştürmektir.
...
├── Ecommerce_Business_SQL_Analysis/      # İş odaklı ana SQL projesi
